...
<body>
    ...
    def _generate_table_element(block) -> str:
        """
        Generates an absolutely positioned wrapper for the native HTML <table>
        generated by Mammoth. Perfectly covers the original English table on the PNG.
        """
        # Le conteneur parent masque l'anglais en dessous grâce à son fond blanc opaque
        return f"""
        <div class="block-element" style="
            ...
            overflow: visible;
        ">
            {block.html_content}  <!-- Code HTML de tableau impeccable généré par Mammoth ! -->
        </div>\n
        """