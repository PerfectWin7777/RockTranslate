...
Path: src/rocktranslate/ui_pyqt/widget/translation_settings_dialog.py
...
try:
    from src.rocktranslate.core.constants import THRESHOLD_PX, SLIDING_CONTEXT_MAX_SIZE, MAX_SEGMENTS_PER_BATCH, MAX_RETRIES
except ImportError:
    from src.rocktranslate.core.constants import THRESHOLD_PX, SLIDING_CONTEXT_MAX_SIZE, MAX_SEGMENTS_PER_BATCH, MAX_RETRIES
