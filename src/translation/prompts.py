...
def get_system_prompt(target_lang: str = DEFAULT_LANG_NAME) -> str:
    ...
    """
    return f"""You are an expert scientific document translator specializing in \
Earth sciences, geomorphology, and geology.
...
def get_user_message(batch: list[dict]) -> str:
    """
